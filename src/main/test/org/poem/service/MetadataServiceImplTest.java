...
public class MetadataServiceImplTest {
    ...
    @org.junit.Test
    public void saveDB() {
        List<DbVO> dbVOS = gatherService.getSchema( "345996872785203200" );
        for (DbVO dbVO : dbVOS) {
            System.out.println( JSONObject.toJSONString( dbVO ) );
        }
        this.metadataService.deleteAllDataGatherInfoId( "345996872785203200" );
        this.metadataService.saveDB( dbVOS, "345996872785203200" );
    }


    @org.junit.Test
    public void getAllDB() {
        List<DbVO> dbVOS = metadataService.getAllDB( "345996872785203200" );
        for (DbVO dbVO : dbVOS) {
            System.out.println( JSONObject.toJSONString( dbVO ) );
        }
    }
    ...
    public void saveTable() {
        GatherVO gatherVO = this.metadataService.getGatherVOById( "345996872785203200" );
    ...
    public void getAllTable() {
        List<TableVO> tableVOS = metadataService.getTable( "346000843771875330" );
        for (TableVO tableVO : tableVOS) {
            System.out.println( JSONObject.toJSONString( tableVO ) );
        }
    }
