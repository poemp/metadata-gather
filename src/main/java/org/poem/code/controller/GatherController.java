package org.poem.code.controller;
...
public class GatherController {
    ...
    @GetMapping(value = "/getTableFields")
    public  List<TableFieldsVO> getTableFields(TableVO tableVO){
    ...
    public void getDbAndTableAndFieldAndSave(String gatherId,String  db, String table) {
        GatherDBTableFieldsVO dbTableFieldsVO = this.gatherService.getAllGatherDBTableFieldsVO( gatherId , db, table);
        this.metadataService.saveGather( dbTableFieldsVO );
    }
